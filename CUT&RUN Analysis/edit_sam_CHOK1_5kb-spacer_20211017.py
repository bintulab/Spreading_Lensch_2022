...
### EDIT THIS ###
readLen = 150
reporter = 'MI-HAC_phiC31-neo-TRE-pEF-H2B-citrine-5kblambda-pRSV-H2B-mcherry'
repElmts = {'AmpR_1':[3172, 3959], 'PGK_1':[4150, 4663], 'PGK_2':[4792, 5302], 'BGHpA':[6439, 6715],
			'H2B_1':[8246, 8623], 'SV40-polyA_1':[9447, 9830], 'H2B_2':[15163, 15540],
			'SV40-polyA_2':[16282, 16507], 'AmpR_2':[16622, 17409], 'ori':[17531, 18213],
			'PGK_3':[18862, 19369], 'PGK_4':[19459, 19965], 'PGK_5':[20059, 20566]}
